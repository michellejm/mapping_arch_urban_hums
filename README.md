...
We are in the midst of a technological revolution, resulting in seemingly endless amounts of data and the computing technologies to analyze and contextualize that data. In response, our relationship to the spaces we inhabit and those that we don't has shifted. We are challenged to make sense of spaces we have never visited, analyze data we did not collect and bring together people and ideas that have never met. As these forces propel us towards increased global awareness, there is a resurgence of the role of place in our cultural conversations and ideas of "local" that appear everywhere from mapping to the grocery store.

This course explores these forces through an introduction to mapping theory and the use of geographic information systems for analysis. We will use open source GIS Software (QGIS), and publicly available datasets to critically apply geographic thinking to humanistic problems. Through this course, students will develop the technological and analytical skills necessary to engage in spatial analysis and representation.

Using a hybrid flipped-classroom approach, students will work through technical tutorials, complete hands-on mapping exercises, and situate this work within theories of mapping viewed through the themes of space, place, and time.
...
By the end of this course, students will be able to:
    ...
    * Strategically use maps and layers to tell a story about data
    * Critically apply mapping theory to spatial projects
    * Find publicly available geolocated datasets
	...
	* Discuss the differences between space and place, and their relationships to time
...
## Course Design
This course is a project-based, hybrid seminar/laboratory. Each session will be divided into two section. In the first half, we will discuss one element of critical cartographic theory. In the second half, we will discuss the tutorial and its implications. To get the most out of the second half, you will need to do the tutorial in advance.

## Assignments 
There are weekly assignments that result from the tutorials. These are graded by submission only.  Please submit them via email by Friday at 10am. If you need an extension, you must ask for it on Thursday. Extensions will not be granted on Friday. 

## Midterm & Final
The Midterm leads to the final. By the midterm, you should have a question or thesis that you want to explore, analyze, or explain using some type of map. This will form the basis of your final project. Projects can be web, digital, or analogue, but must take the viewer through your hypothesis, argument, or story. The final project will be the execution of your research and design. The white paper will discuss the methods you used and decisions you made. Detailed descriptions will be distributed at least three weeks in advance.  
...
* Course overview
* What is GIS?
* Asking questions about space
* Geohumanities/"the spatial turn"
...
Introduction
* Why QGIS?
* Shapefiles and folder structures
